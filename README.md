...
tedious. It bundles three small functions: `sort_mutate()`,
`drop_na_rows()`, and `top_n_percent()`, that each collapse a common
multi-step task into a single, readable call.
